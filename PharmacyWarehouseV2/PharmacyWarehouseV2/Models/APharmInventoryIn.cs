...
{
    public partial class APharmInventoryIn
    {
        public APharmInventoryIn()
        {
            APharmInvInItemPackages = new HashSet<APharmInvInItemPackage>();
        }
        ...
        public virtual ICollection<APharmInvInItemPackage> APharmInvInItemPackages { get; set; }
    }
}
