...
{
    public partial class APharmInvOutItemPackage
    {
        public APharmInvOutItemPackage()
        {
            APharmInvOutItemPackageReceipts = new HashSet<APharmInvOutItemPackageReceipt>();
        }
        ...
        public virtual APharmInventoryOut InventoryOut { get; set; } = null!;
        public virtual ICollection<APharmInvOutItemPackageReceipt> APharmInvOutItemPackageReceipts { get; set; }
    }
}
